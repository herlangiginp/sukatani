                ...
                <div class="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-end mb-5">
                        <li class="nav-item me-2">
                            <a class="btn btn-outline-success border-2 active" data-bs-toggle="pill" href="#tab-1">Terdekat</a>
                        </li>
                        <li class="nav-item me-2">
                            <a class="btn btn-outline-success border-2" data-bs-toggle="pill" href="#tab-2">Termurah</a>
                        </li>
                        <li class="nav-item me-0">
                            <a class="btn btn-outline-success border-2" data-bs-toggle="pill" href="#tab-3">Termahal </a>
                        </li>
                    </ul>
                </div>
            </div>
                                      ...
                                      <div class="product-cart-wrap mb-30">
                                          <div class="product-img-action-wrap">
                                              <div class="product-img product-img-zoom">
                                                  <a href="product-details.html">
                                                      <img class="default-img" src="img/b putih 1 (1).jpg" alt="">
                                                      <img class="hover-img" src="img/b merah 1.png" alt="">
                                                  </a>
                                              </div>
                                        ...
                                        <div class="product-content-wrap">
                                              <div class="product-category">
                                                  <a href="shophtml">Clothing</a>
                                              </div>
                                                <h2><a href="product-details.html">Plain Color Pocket Shirts</a></h2>
                                              <div class="product-price">
                                                <span>Rp.70.000 </span> <span class="old-price">Rp.50.000</span>
                                              </div>
                                        </div> 
                                              <div class="product-action-1 show">
                                                  <a aria-label="Add To Cart" class="action-btn hover-up" href="cart.html"><i class="bi bi-bag-plus"></i></a>
                                              </div>
                                    </div>
                                </div>
                ...
                <div class="product-content-wrap">
                      ...
                      <div class="product-action-1 show">
                        ...
                        <div class="col-12 text-center">
                            <a class="btn btn-success rounded-pill py-3 px-5" href="">Cari Lebih Banyak Produk</a>
                        </div>
                    </div>
                </div>
            </div>
