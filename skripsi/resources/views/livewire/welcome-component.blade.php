                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <x-nav-link :href="route('shop')" :active="request()->routeIs('shop')">
                                        <span  class="btn btn-success py-sm-3 px-sm-4">Cari Kebutuhan mu!</span>
                                    </x-nav-link>
                                </div>
                            </div>
                        </div>
                                  ...
                                  <div class="product-content-wrap">
                                      ...
                                      <div class="product-action-1 show">
                                        <x-responsive-nav-link :href="route('login')">
                                            <button aria-label="Keranjang" class="action-btn hover-up"><i class="bi bi-bag-plus m-2"></i></button>
