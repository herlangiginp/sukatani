        ...
        <div class="container bg-white radius p-4">
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 col-sm-6 d-flex justify-content-end mb-3">
                    <a href="{{route('user.product')}} " class="btn btn-success ">Tampilkan semua Barang</a> 
                </div>
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="updateProduct" >
                            <div class="my-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan nama Barang, contoh (beras merah merk rojolele)" wire:model="name" wire:keyup="generateSlug">
                                @error('name')
                            ...
                            <div class="my-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan slug barang " wire:model="slug">
                                @error('slug')
                                <p class="text-danger">{{$message}} </p>
                                @enderror
                            </div>
                            <div class="my-3">
                                ...
                                <textarea class="form-control" placeholder="Masukan deskripsi singkat barang" wire:model="deskripsi_pendek"></textarea>
                                @error('slug')
                                <p class="text-danger">{{$message}} </p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select class="form-control" name="status_barang" wire:model="status_barang">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                @else   
                                <img src="{{asset('img/produk')}}/{{$image}}" alt="">
                                @endif
                                @error('newimage')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                            ...
                            <button type="submit" class="btn btn-lg float-end " name="submit" class="btn button-success">Perbaharui</button>
                        </form>
                    </div>
            </div>
        </div>
