    ...
    <div class="container bg-white radius p-4">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3 col-sm-6 d-flex justify-content-end mb-3">
                <a href="{{ route('admin.product.add') }}" class="btn btn-success">Tambahkan barang</a>
                ...
                <table class="table shopping-summery text-center clean">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.product.edit', ['product_id' =>$product->id])}}" class="btn btn-success mx-2">Edit</a>
                                </td>
